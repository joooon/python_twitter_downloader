...
def filter_blacklisted_tweets(
    configuration: ConfigParser, tweets_list: tweepy.models.ResultSet
...
def update_tweets_blacklist(
    configuration: ConfigParser, new_blacklisted_tweets: List[str], tweets_list: tweepy.models.ResultSet
):
    """
    ...
    if not new_blacklisted_tweets and len(valid_blacklisted_tweets) == len(previous_blacklisted_tweets):
